\documentclass[$if(fontsize)$$fontsize$,$else$12pt,$endif$$if(one_column)$$if(lineno)$lineno,$endif$$else$onecolumn,$endif$$if(one_sided)$$else$twoside,$endif$printwatermark=$if(watermark)$$watermark$$else$false$endif$]{modeloLEA}
...
$else$
\definecolor{pinpblue}{HTML}{000000}  % imagecolorpicker on blue for new R logo
$endif$
$if(linkcolor)$
